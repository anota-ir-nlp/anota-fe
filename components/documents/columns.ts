...
export function createColumns(
  ...
  handleExportDocument: (document: DocumentResponse, format: 'parallel' | 'm2') => void,
  ...
  return [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return h('span', { class: 'text-gray-700' }, date.toLocaleDateString('id-ID'))
      },
      enableSorting: false,
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return h('div', { class: 'flex gap-2 justify-end' }, [
          ...
          h(Button, {
            ...
            h(RotateCcw, { class: 'w-4 h-4 mr-1' }),
            'Reopen'
          ]),
          h(Button, {
            size: 'sm',
