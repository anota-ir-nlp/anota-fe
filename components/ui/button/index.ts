  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-2 bg-white/90 border-red-300 text-red-700 shadow-xs hover:bg-red-50 hover:border-red-500 hover:text-red-800 backdrop-filter backdrop-blur-sm transition-all duration-200",
        outline:
        ...
        secondary:
          "border-2 bg-white/90 border-blue-300 text-blue-700 shadow-xs hover:bg-blue-50 hover:border-blue-500 hover:text-blue-800 backdrop-filter backdrop-blur-sm transition-all duration-200",
        ghost:
      ...
      size: {
        ...
        xl: "h-12 rounded-md px-10 py-4 text-lg font-bold",
        icon: "size-9",
      },
    },
    defaultVariants: {
