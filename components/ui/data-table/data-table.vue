...
<template>
    <div>
        <div class="rounded-md overflow-hidden">
            <Table>
                <TableHeader>
                    <TableRow v-for="headerGroup in table.getHeaderGroups()" :key="headerGroup.id" class="bg-gray-800/60 hover:bg-gray-800/60">
                        <TableHead v-for="header in headerGroup.headers" :key="header.id" class="text-gray-300 font-medium text-left">
